\chapter{Supplementary material for Chapter 2}\label{apx:ch2}
\newpage
...
\begin{table}[!ht]
	...
	\label{apx:stock_mod}
		...
		\toprule
\input{chapters/Chapter2_carbon/figs/stock_mod_table.tex}
			\bottomrule
			\end{tabular}
	\end{table}
...
\begin{figure}[!ht]
  \centering
	\includegraphics[width=.9\textwidth]{chapters/Chapter2_carbon/figs/stockmod_pairplot.png}
...
\begin{figure}[!ht]
  \centering
	\includegraphics[width=.7\textwidth]{chapters/Chapter2_carbon/figs/density_mod.png}
